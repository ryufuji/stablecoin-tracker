...
出力形式:
{
  "summary_ja": "日本語で3行の要約（各行は簡潔に）",
  "category": "規制 | 技術 | 市場 | DeFi | 事件 のいずれか1つ",
  "projects": ["言及されたステーブルコインプロジェクト名のリスト"],
  "importance": 1から5の整数（1=低い重要度, 5=非常に重要）
}

JSONのみを返してください。説明は不要です。"""

VALID_CATEGORIES = {"規制", "技術", "市場", "DeFi", "事件"}
